...
const localTranslations = {
  Spanish: {
    ...
    "Sign In": "Iniciar sesión", "Explore Platform": "Explorar plataforma",
    "or": "o", "Back": "Atrás",
    ...
    "Trusted AI assistance for fans, staff and venue operations": "Asistencia de IA de confianza para aficionados, personal y operaciones.",
    "Choose Your Matchday Experience": "Elija su experiencia del día del partido",
    "Fan Experience": "Experiencia del aficionado",
    "Venue Operations": "Operaciones del estadio",
    "Operations Command Center": "Centro de comando de operaciones",
    "Verified-source guidance": "Guía de fuente verificada",
    "Crowd-aware navigation": "Navegación consciente de la multitud",
    "Multilingual assistance": "Asistencia multilingüe",
    "Accessibility-first matchday support": "Soporte de accesibilidad para el día del partido",
    "OpenStreetMap navigation": "Navegación OpenStreetMap",
    "© FIFA World Cup 2026 Operations.": "© FIFA World Cup 2026 Operaciones.",
    "Smart Routing": "Ruta inteligente", "AI Translation": "Traducción IA",
    "Accessibility": "Accesibilidad", "Verified Assistance": "Asistencia verificada",
    "Email Address": "Correo electrónico", "Password": "Contraseña",
    "Sign In with Email": "Iniciar sesión con correo",
    "Sign In with Google": "Iniciar sesión con Google",
    "Access Your Matchday Workspace": "Acceso a su espacio de trabajo",
    "Quick Access": "Acceso rápido",
    "Continue as Fan": "Continuar como aficionado",
    "Continue as Staff": "Continuar como personal",
    "Continue as Organizer": "Continuar como organizador",
    "Matchday Hub": "Centro del día del partido",
    "Your routes, venue services and operational updates in one place.": "Sus rutas, servicios del estadio y actualizaciones operativas en un solo lugar.",
  ...
  French: {
    ...
    "Sign In": "Se connecter", "Explore Platform": "Explorer la plateforme",
    "or": "ou", "Back": "Retour",
    ...
    "Trusted AI assistance for fans, staff and venue operations": "Assistance IA de confiance pour les supporters, le personnel et les opérations.",
    "Choose Your Matchday Experience": "Choisissez votre expérience de match",
    "Fan Experience": "Expérience Supporter",
    "Venue Operations": "Opérations du Stade",
    "Operations Command Center": "Centre de Commandement des Opérations",
    "Verified-source guidance": "Conseils de source vérifiée",
    "Crowd-aware navigation": "Navigation sensible à la foule",
    "Multilingual assistance": "Assistance multilingue",
    "Accessibility-first matchday support": "Soutien à l'accessibilité le jour du match",
    "OpenStreetMap navigation": "Navigation OpenStreetMap",
    "© FIFA World Cup 2026 Operations.": "© FIFA World Cup 2026 Opérations.",
    "Smart Routing": "Routage intelligent", "AI Translation": "Traduction IA",
    "Accessibility": "Accessibilité", "Verified Assistance": "Assistance vérifiée",
    // ── Login Page ───────────────────────────────────────────────
    "Email Address": "Adresse e-mail", "Password": "Mot de passe",
    "Sign In with Email": "Se connecter avec l'e-mail",
    "Sign In with Google": "Se connecter avec Google",
    "Access Your Matchday Workspace": "Accédez à votre espace de travail",
    "Quick Access": "Accès rapide",
    "Continue as Fan": "Continuer comme Supporter",
    "Continue as Staff": "Continuer comme Personnel",
    "Continue as Organizer": "Continuer comme Organisateur",
    "Matchday Hub": "Carrefour du jour de match",
    "Your routes, venue services and operational updates in one place.": "Vos itinéraires, services du stade et mises à jour opérationnelles au même endroit.",
  ...
  German: {
    ...
    "Sign In": "Anmelden", "Explore Platform": "Plattform erkunden",
    "or": "oder", "Back": "Zurück",
    ...
    "Trusted AI assistance for fans, staff and venue operations": "Zuverlässige KI-Unterstützung für Fans, Mitarbeiter und Stadionbetrieb.",
    "Choose Your Matchday Experience": "Wählen Sie Ihr Spieltagserlebnis",
    "Fan Experience": "Fan-Erlebnis",
    "Venue Operations": "Stadionbetrieb",
    "Operations Command Center": "Betriebsleitung",
    "Verified-source guidance": "Verifizierte Unterstützung",
    "Crowd-aware navigation": "Crowd-aware Navigation",
    "Multilingual assistance": "Mehrsprachige Unterstützung",
    "Accessibility-first matchday support": "Barrierefreie Spieltagsunterstützung",
    "© FIFA World Cup 2026 Operations.": "© FIFA WM 2026 Betrieb.",
    "Smart Routing": "Intelligentes Routing", "AI Translation": "KI-Übersetzung",
    "Accessibility": "Barrierefreiheit", "Verified Assistance": "Verifizierte Unterstützung",
    // ── Login Page ───────────────────────────────────────────────
    "Email Address": "E-Mail-Adresse", "Password": "Passwort",
    "Sign In with Email": "Mit E-Mail anmelden",
    "Sign In with Google": "Mit Google anmelden",
    "Access Your Matchday Workspace": "Zugriff auf Ihren Spieltags-Arbeitsbereich",
    "Quick Access": "Schnellzugriff",
    "Continue as Fan": "Weiter als Fan",
    "Continue as Staff": "Weiter als Personal",
    "Continue as Organizer": "Weiter als Organisator",
    "Matchday Hub": "Spieltags-Hub",
    "Your routes, venue services and operational updates in one place.": "Ihre Routen, Stadiondienste und betrieblichen Updates an einem Ort.",
  ...
  Hindi: {
    ...
    "Sign In": "साइन इन करें", "Explore Platform": "प्लेटफ़ॉर्म देखें",
    "or": "या", "Back": "वापस",
    ...
    "Trusted AI assistance for fans, staff and venue operations": "प्रशंसकों, कर्मचारियों और आयोजन संचालन के लिए विश्वसनीय AI सहायता।",
    "Choose Your Matchday Experience": "अपना मैचडे अनुभव चुनें",
    "Fan Experience": "प्रशंसक अनुभव",
    "Venue Operations": "स्थल संचालन",
    "Operations Command Center": "संचालन नियंत्रण केंद्र",
    "Verified-source guidance": "सत्यापित मार्गदर्शन",
    "Crowd-aware navigation": "भीड़-जागरूक नेविगेशन",
    "Multilingual assistance": "बहुभाषी सहायता",
    "Accessibility-first matchday support": "पहुंच-प्रथम मैचडे सहायता",
    "© FIFA World Cup 2026 Operations.": "© FIFA WM 2026 संचालन।",
    "Smart Routing": "स्मार्ट रूटिंग", "AI Translation": "AI अनुवाद",
    "Accessibility": "पहुंच", "Verified Assistance": "सत्यापित सहायता",
    // ── Login Page ───────────────────────────────────────────────
    "Email Address": "ईमेल पता", "Password": "पासवर्ड",
    "Sign In with Email": "ईमेल से साइन इन करें",
    "Sign In with Google": "गूगल से साइन इन करें",
    "Access Your Matchday Workspace": "अपने मैचडे वर्कस्पेस में प्रवेश करें",
    "Quick Access": "त्वरित पहुंच",
    "Continue as Fan": "प्रशंसक के रूप में आगे बढ़ें",
    "Continue as Staff": "कर्मचारी के रूप में आगे बढ़ें",
    "Continue as Organizer": "आयोजक के रूप में आगे बढ़ें",
    "Matchday Hub": "मैचडे हब",
    "Your routes, venue services and operational updates in one place.": "आपके मार्ग, स्थल सेवाएं और परिचालन अपडेट एक ही स्थान पर।",
  ...
  Telugu: {
    ...
    "Sign In": "సైన్ ఇన్ చేయండి", "Explore Platform": "ప్లాట్‌ఫాంను అన్వేషించండి",
    ...
    "Trusted AI assistance for fans, staff and venue operations": "అభిమానులు, సిబ్బంది మరియు వేదిక కార్యకలాపాలకు విశ్వసనీయ AI సహాయం.",
    "Choose Your Matchday Experience": "మీ మ్యాచ్‌డే అనుభవాన్ని ఎంచుకోండి",
    "Fan Experience": "అభిమాని అనుభవం",
    "Venue Operations": "వేదిక కార్యకలాపాలు",
    "Operations Command Center": "కార్యాచరణ కమాండ్ సెంటర్",
    "Verified-source guidance": "ధృవీకరించబడిన మార్గదర్శకత్వం",
    "Crowd-aware navigation": "క్రౌడ్-అవేర్ నావిగేషన్",
    "Multilingual assistance": "బహుభాషా సహాయం",
    "Accessibility-first matchday support": "అందుబాటు-మొదటి మ్యాచ్‌డే మద్దతు",
    "© FIFA World Cup 2026 Operations.": "© FIFA WM 2026 కార్యకలాపాలు.",
    "Smart Routing": "స్మార్ట్ రూటింగ్", "AI Translation": "AI అనువాదం",
    "Accessibility": "అందుబాటు", "Verified Assistance": "ధృవీకరించబడిన సహాయం",
    // ── Login Page ───────────────────────────────────────────────
    ...
    "Access Your Matchday Workspace": "మీ మ్యాచ్‌డే వర్క్‌స్పేస్ యాక్సెస్ చేయండి",
    "Quick Access": "త్వరిత యాక్సెస్",
    "Continue as Fan": "అభిమానిగా కొనసాగండి",
    "Continue as Staff": "సిబ్బందిగా కొనసాగండి",
    "Continue as Organizer": "నిర్వాహకుడిగా కొనసాగండి",
    "Matchday Hub": "మ్యాచ్‌డే హబ్",
    "Your routes, venue services and operational updates in one place.": "మీ మార్గాలు, వేదిక సేవలు మరియు కార్యాచరణ నవీకరణలు ఒకే చోట.",
